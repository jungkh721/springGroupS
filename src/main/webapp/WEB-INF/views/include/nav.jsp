...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.56:9090/springGroupS/" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      <button class="w3-padding-large w3-button" title="More">Stuty1 <i class="fa fa-caret-down"></i></button>     
